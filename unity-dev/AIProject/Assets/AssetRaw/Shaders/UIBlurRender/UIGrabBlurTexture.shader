Shader "UI/UIGrabBlurTexture"
{
	...
	half4 frag (v2f input) : SV_Target
	{
		...
		half4 color1 = SAMPLE_TEXTURE2D(_GrabTex, sampler_LinearRepeat, input.screenPos);
		half4 color2 = SAMPLE_TEXTURE2D(_GrabBlurTex, sampler_LinearRepeat, input.screenPos);
